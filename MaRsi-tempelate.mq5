...
sinput string s3; //---------------------------
input int num_lots                         = 10;           // Number of lots
input double TK                            = 30;            // Take Profit
input double SL                            = 3;            // Stop Loss

sinput string s4; //---------------------------
input string limit_close_op                 = "23:40";       // Time Limit Close Position
